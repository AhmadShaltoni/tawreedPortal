...
import { createDiscountCode } from '@/actions/discount-codes'
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="flex items-center gap-2 text-sm">
        ...
        <span className="text-gray-600">كود خصم جديد</span>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center gap-3 p-4 bg-green-50 border border-green-200 rounded-lg">
          ...
          <label htmlFor="isActive" className="cursor-pointer flex-1">
            <span className="font-medium">تفعيل الكود فوراً</span>
          </label>
        </div>
        ...
        <div className="flex gap-4">
          <Button type="submit" disabled={loading} className="flex-1">
            {loading ? 'جاري الحفظ...' : 'حفظ كود الخصم'}
          </Button>
