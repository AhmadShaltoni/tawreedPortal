...
import { ArrowLeft, MapPin, Calendar, Package, DollarSign, Truck, CheckCircle } from 'lucide-react'
...
export default async function BuyerOrderDetailPage({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      {/* Back Link */}
      <Link href="/buyer/orders" className="inline-flex items-center text-gray-600 hover:text-gray-900">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="text-right">
          ...
          <p className="text-2xl font-bold text-blue-900">{formatCurrency(order.totalPrice)}</p>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-semibold">{order.supplier.storeName || order.supplier.username}</p>
                    <p className="text-sm text-gray-600">{order.supplier.city}</p>
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-semibold mb-4">Related Request</h3>
              <Link 
                href={`/buyer/requests/${order.requestId}`}
